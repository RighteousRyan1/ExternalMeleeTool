...
dotnet publish EMTDisplay.csproj -c Release -r win-x64 --self-contained true -p:PublishAot=true
goto :end

:compile_r2r
echo.
echo Compiling EMTDisplay with Ready-to-Run...
dotnet publish EMTDisplay.csproj -c Release -r win-x64 --self-contained true -p:PublishSingleFile=true -p:PublishReadyToRun=true -p:PublishTrimmed=true 
